...
<template>
	<view class="about">
		...
		<view class="titleZ text-center align-center">
			...
			<view class="contentZ">
				<text class="text-xl">作者:奎奎网络，一名乌黑秀发的九零后web前端程序员</text>
			</view>
		</view>

		<view class="titleZ text-center align-center margin-top-xl">
			<text class="text-bold">不定时更新</text>
			<view class="contentZ margin-top-lg">
				<text class="text-xl text-bold">「家人们」</text>
				<text class="text-xl">：兄弟们～</text>
			</view>
			<view class="contentZ" style="margin-top: 40rpx;">
				<text class="text-xl text-bold">「兄弟们」</text>
				<text class="text-xl">：软件使用愉快...</text>
			</view>
		</view>
		<!-- 小程序开启客服会话 -->
