	...
	<view>
		...
		<view class="cu-bar bg-white margin-top-xs">
			<view class="action sub-title">
				<text class="text-xl text-bold text-blue text-shadow">邮箱信息</text>
				<text class="text-ABC text-blue">eml</text>
			</view>
		</view>
		<!-- <u-cell-group>
			<u-cell-item @click="look(1)" icon="email" title="邮箱账号" :label="emlObj.name" value="点击复制"
				:arrow="false"></u-cell-item>
			<u-cell-item @click="look(0)" icon="integral-fill" title="邮箱密码" :label="emlObj.password" value="点击复制"
				:arrow="false"></u-cell-item>
		</u-cell-group> -->
		<u-cell-group class="bg-white margin-top-xs">
			<u-cell-group>
				<u-cell @click="look(1)" icon="email" title="邮箱账号" :label="emlObj.name" value="点击复制" :arrow="false"
					center></u-cell>
				<u-cell @click="look(0)" icon="integral-fill" title="邮箱密码" :label="emlObj.password" value="点击复制"
					:arrow="false" center></u-cell>
			</u-cell-group>
		</u-cell-group>
		<u-button class=" margin-top-lg" type="success" style="width: 250rpx;" @click="getData">刷新账号</u-button>
		<u-divider text="使用说明" textColor="#2979ff" lineColor="#2979ff"
			style="width: 500rpx;margin: 0 auto;margin-top: 50rpx;"></u-divider>
		<view style="margin-left: 30rpx;margin-right: 30rpx;">

			<u--text type="primary" style="padding: 15rpx;" text="获取随机网易邮箱账号(共有2000左右帐号)
"></u--text>
			<u--text type="primary" style="padding: 15rpx;" text="1.可发邮件，可收邮件,用来做什么事情都可以"></u--text>
			<u--text type="primary" style="padding: 15rpx;"text="2.可用 网易邮箱大师APP 登录"></u--text>
			<u--text mode="link" style="padding: 15rpx;" text="Go to 网易邮箱大师APP" href="https://dashi.163.com/m/?from=mail11&fromDlpro=1" ></u--text>
		<u--text type="primary" style="padding: 15rpx;"text="3.可用 网易邮箱大师APP 登录"></u--text>
			<u--text  mode="link" style="padding: 15rpx;" text="Go to 网易邮箱网页版" href="http://mail.126.com" ></u--text>
		<u--text type="primary" style="padding: 15rpx;"text="4.可以登录游戏"></u--text>
		<u--text type="primary" style="padding: 15rpx;"text="5.也可以diss别人,每个人用多少次都没问题"></u--text>
		<u--text type="primary" style="padding: 15rpx;"text="6.永久免费，永久开放！！！"></u--text>
		</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				text: '可用于登陆邮箱,登陆邮箱,发邮件,给骗子发diss邮件也是可以的,用处多多!!!!',
		...
		methods: {
			look(state) {
				if (state) {
					uni.setClipboardData({
						data: this.emlObj.name
					});
				} else {
					uni.setClipboardData({
						data: this.emlObj.password
					});
				}
			...
			getData() {
				...
				uni.request({
					url: 'http://qstgg.xn--6qqr26f.ml/yxx.php',
					data: {
						// platform: platform,
					...
					success: (result) => {
						...
						this.emlObj.name = data[0]
						this.emlObj.password = data[1]
						console.log(data);
						uni.hideLoading();
					},
					fail: (res) => {
